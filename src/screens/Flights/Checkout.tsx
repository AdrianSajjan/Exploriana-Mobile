...
type NavigationProps = NativeStackNavigationProp<AppStackParamList, "Flight-Checkout">;
...
const FlightIcon = <Flight height={20} width={20} fill={theme.colors.text} />;
...
export function FlightCheckoutScreen() {
  ...
  async function handleCheckout() {
    ...
    try {
      ...
      ToastAndroid.show(`Your booking for flight number ${transport.selected.id} is created.`, ToastAndroid.LONG);
  ...
  if (!transport.selected) return <Navigate to="Search-Flights" />;
  ...
  return (
    <SafeAreaView style={sharedStyles.fullHeight}>
      ...
      <ScrollView contentContainerStyle={[sharedStyles.fullGrow, sharedStyles.pvSmall, sharedStyles.ph]}>
        ...
        <Box marginTop={36}>
          <TransportCard cover={require("assets/images/Flight.png")} icon={FlightIcon} data={transport.selected} />
        </Box>
        <Box marginTop={32}>
